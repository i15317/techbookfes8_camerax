...
package jp.digital_future.cameraxsample.ui
...
//        }
        ...
        useCase.setOnPreviewOutputUpdateListener(Preview.OnPreviewOutputUpdateListener { output ->
            ...
            val rotation = getDisplaySurfaceRotation(viewFinder.display)
            updateTransform(viewFinder, rotation, output.textureSize, viewFinderDimens)
        })
